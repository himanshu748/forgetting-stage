...
- The current repository and MIT license support Next Gen. Student status, the RevenueCat project, a native Test Store purchase and device footage remain unverified.
...
| Best Game | The player directs a three-actor improvised tragedy, pins one truth and watches two confident realities diverge | Ten-round replayable loop, three premises, pin, director note, contradiction report and genre-safe monetization timing | Native play footage, observed fun and polish, RevenueCat Test Store purchase |
...
| HAMM | One free show per day creates habit without blocking discovery. A consumable encore serves occasional players and Director's Pass serves frequent players. No offer interrupts a performance | RevenueCat purchase and restore adapter, daily ledger, consumable encore handling, entitlement path, lobby paywall and curtain-only house message | Real project and products, observed Test Store purchase and restore, chosen pricing, truthful conversion results if any |
...
1. Create the RevenueCat Test Store products and complete one purchase plus restore on the target device.
